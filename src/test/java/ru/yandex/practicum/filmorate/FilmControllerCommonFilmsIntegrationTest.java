...
class FilmControllerCommonFilmsIntegrationTest {
    ...
    @Test
    void findCommonFilms_shouldReturnSortedFilms() throws Exception {
        ...
        mockMvc.perform(get("/films/common")
                        ...
                        .param("friendId", u2.getId().toString())
    ...
    @Test
    void findCommonFilms_whenUserNotFound_shouldReturnNotFound() throws Exception {
        User u1 = createAndSaveUser("u1@test.com", "u1");
    ...
    @Test
    void findCommonFilms_whenFriendNotFound_shouldReturnNotFound() throws Exception {
        User u1 = createAndSaveUser("u1@test.com", "u1");

        mockMvc.perform(get("/films/common")
                        .param("userId", "999")
                        .param("friendId", u1.getId().toString())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }

    @Test
    void findCommonFilms_whenNoCommonFilms_shouldReturnEmptyList() throws Exception {
        User u1 = createAndSaveUser("u1@test.com", "u1");
        User u2 = createAndSaveUser("u2@test.com", "u2");
